...
const calculateTotalQuantity = cart.reduce((prevValue, item) => {
  ...
  const handleRemoveFromCart = (product) => {
                    ...
                    <div className='product-list'>
                        {category.plants.map((plant,plantIndex) => (
                            <div className="product-card" key={plantIndex}>
                                ...
                                <button  className={`product-button ${addedToCart[plant.name] ? 'added-to-cart' : ''}`} onClick={() => handleAddToCart(plant)} disabled={addedToCart[plant.name]} >{!addedToCart[plant.name] ? 'Add to Cart' : 'Added to Cart'}</button>
                            </div>
                        ))};
                    </div>
                </div>
    ...
    <CartItem onContinueShopping={handleContinueShopping} onRemovingFromCart={handleRemoveFromCart}/>
)}
    </div>
    );
}
